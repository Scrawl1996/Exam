...
public interface EmpoutDistributeService {
	 ...
	 * @param currentCount	当前页大小
	 * @param condition	组合条件
	 * @return
	 * @throws SQLException
	 */
	public PageBean<Map<String,Object>> getDistributeInfoWithCondition(int currentPage,int currentCount,Map condition)throws SQLException;
	/**
	 * 根據大修ID和单位ID查询大修单位信息
	 * @param bigId	大修ID
	 * @param unitId	單位ID
	 ...
	 * @throws SQLException
	 */
	public boolean updateFenpeiInfo(String departmentIds,Employeeoutdistribute employeeoutdistribute)throws SQLException;
}
