...
public class DepartmentCountAction extends ActionSupport {
	...
	public String findDepartmentInFormalCountInfo() {
		...
		try {
			pageBean = departmentService.getDepartmentInFormalCountInfo(Integer.valueOf(currentPage),
	...
	public String findDepartmentInToDoCountInfo() {
		...
		PageBean<Map<String, Object>> pageBean = null;
		try {
			pageBean = departmentService.getDepartmentInToDoCountInfo(Integer.valueOf(currentPage),
					Integer.valueOf(currentCount), condition);
		} catch (Exception e) {
			e.printStackTrace();
		}
