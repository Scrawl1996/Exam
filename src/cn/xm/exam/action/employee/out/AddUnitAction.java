...
import cn.xm.exam.action.common.MessageAction;
...
public class AddUnitAction extends ActionSupport implements ModelDriven<Unit> {
	...
	private static final Logger log = LoggerFactory.getLogger(AddUnitAction.class);
	@Autowired
