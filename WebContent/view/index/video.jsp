...
<div class="panel-body">
    ...
    <div id="videoLeft">
        ...
        <div class="panel-heading"><h4>培训视频</h4></div>
        <!--视频-->
    ...
    <div id="videoRight">
		...
		<video id="showVideo" class="el_video" style="display:block;height:100%;width:100%; margin:0 auto;"  src="/file/${traincontent.currentname }" controls="controls">
