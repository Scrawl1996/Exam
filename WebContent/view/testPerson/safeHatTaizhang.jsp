...
function queryTaizhangInfo(){
	$.post(baseurl+"/safeHat_getSafehatTaizhang.do",$("#queryTaizhangForm").serialize(),function(responseMap){
		if(responseMap && responseMap.pageInfo){
			...
			for(var i=0;i<datas.length;i++){
				...
				var tr = "<tr>"+
					...
					+"<td>"+replaceNull(data.thirdScore)+"</td>"
...
function queryHatChangeLog(obj){
	if(obj){
		...
		$.post(baseurl+"/safeHat_getSafehatChangelog.do",{"originSafeHatNum":$(obj).text()},function(res){
			if(res){
